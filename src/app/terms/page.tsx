  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold italic text-zinc-950 mb-2" style={{ fontFamily: 'var(--font-playfair)' }}>Terms of Service</h1>
        <p className="text-zinc-500 mb-10">Last updated: May 2026</p>

        <div className="space-y-8 text-zinc-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">1. Acceptance of Terms</h2>
            <p>By creating an account or using Roomd, you agree to these Terms of Service. If you do not agree, do not use the service.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">5. Affiliate Links & Advertising</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">6. Product Recommendations</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">7. Termination</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">8. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">9. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">10. Contact</h2>
      ...
      <footer className="border-t border-zinc-100 py-8 px-4 text-center text-sm text-zinc-400 mt-12">
