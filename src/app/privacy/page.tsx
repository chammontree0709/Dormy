  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold italic text-zinc-950 mb-2" style={{ fontFamily: 'var(--font-playfair)' }}>Privacy Policy</h1>
        <p className="text-zinc-500 mb-10">Last updated: May 2026</p>

        <div className="prose prose-gray max-w-none space-y-8 text-zinc-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">3. Amazon Affiliate Disclosure</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">4. Advertising</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">5. Data Storage</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">6. Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">8. Children's Privacy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 mb-3">9. Contact</h2>
